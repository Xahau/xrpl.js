 ...
 */
interface _IssueObject extends JsonObject {
  currency: string
  issuer?: string
}
 ...
 */
type IssueObject = XRPIssue | IOUIssue | MPTIssue | _IssueObject
...
class Issue extends SerializedType {
  ...
  static fromParser(parser: BinaryParser): Issue {
    ...
    if (new Currency(currencyOrAccount).toJSON() === nativeAsset.get()) {
